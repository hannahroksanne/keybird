...
const useOutputType = use('outputType')
const getOutputType = get('outputType')
const setOutputType = set('outputType')
...
const toggleIsBuiltInInstrumentSelected = toggle('isBuiltInInstrumentSelected')

const useIsKeybindOverlayOpen = use('isKeybindOverlayOpen')
const getIsKeybindOverlayOpen = get('isKeybindOverlayOpen')
const toggleIsKeybindOverlayOpen = toggle('isKeybindOverlayOpen')

const useWhichChordIsBeingBound = use('whichChordIsBeingBound')
const getWhichChordIsBeingBound = get('whichChordIsBeingBound')
const setWhichChordIsBeingBound = set('whichChordIsBeingBound')

const useChordKeyBinds = use('chordKeyBinds')
const getChordKeyBinds = get('chordKeyBinds')
const setChordKeyBinds = set('chordKeyBinds')

const useBuiltInInstrumentNames = use('builtInInstrumentNames')
...
type StoreT = MainStateT & {
	...
	setChordKeyBinds: (chordKeyBinds: AnyObjectT) => void

	useWhichChordIsBeingBound: () => string
	getWhichChordIsBeingBound: () => string
	setWhichChordIsBeingBound: (whichChordIsBeingBound: string) => void

	useIsKeybindOverlayOpen: () => boolean
	getIsKeybindOverlayOpen: () => boolean
	toggleIsKeybindOverlayOpen: () => void
	...
	toggleIsBuiltInInstrumentSelected: () => void

	useOutputType: () => string
...
export const store: StoreT = {
	...
	toggleIsBuiltInInstrumentSelected,
	useOutputType,
	getOutputType,
	setOutputType,
	useIsKeybindOverlayOpen,
	getIsKeybindOverlayOpen,
	toggleIsKeybindOverlayOpen,
	...
	get chordKeyBinds() {
		return getChordKeyBinds()
	},

	get whichChordIsBeingBound() {
		return getWhichChordIsBeingBound()
	},

	get isKeybindOverlayOpen() {
		return getIsKeybindOverlayOpen()
	},
...
globalThis.useMainStore = useMainStore
