...
var url = function(req) {
  let url2 = req.url;
  if (url2 === void 0) return url2;
  let obj = req._parsedUrl;
  if (obj && obj._raw === url2) return obj;
  obj = {};
...
const serveIndex = (req, res) => {
  ...
  res.end('<!doctype html>\n<html lang="en">\n	<head>\n		<meta charset="UTF-8" />\n		<link rel="icon" type="image/svg+xml" href="/vite.svg" />\n		<meta name="viewport" content="width=device-width, initial-scale=1.0" />\n		<title>keybird</title>\n		<script type="module" crossorigin src="/assets/index-CW16opIo.js"><\/script>\n		<link rel="stylesheet" crossorigin href="/assets/index-5F37YEXw.css">\n	</head>\n	<body class="dark-theme">\n		<div id="root"></div>\n	</body>\n</html>\n');
};
